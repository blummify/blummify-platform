        ...
        <div className="relative z-10 px-8 py-10 lg:px-16 lg:py-14">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-3xl">
              ...
              >
                We help teams design, build, and grow digital products with
                intent. From strategy to execution, we blend modern engineering
                with crisp branding and measurable outcomes.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-surface-container-lowest rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <p className="mt-3 text-on-surface-variant font-body">
                    Clean systems, reliable releases, and thoughtful UX that
                    feels premium.
                  </p>
                </div>
                <div className="bg-surface-container-lowest rounded-[2rem] p-8 transition-all duration-500 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <p className="mt-3 text-on-surface-variant font-body">
                    Strategy-led foundations that scale with your product and
                    your market.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              <div className="bg-surface-container-lowest rounded-[2rem] p-10 transition-all duration-500 hover:shadow-xl">
                ...
                <div className="mt-8 space-y-4 text-on-surface-variant font-body">
                  ...
                  <p>
                    Our approach is simple: clarify the outcome, design the
                    system, execute with quality, and iterate with data.
                  </p>
                </div>
